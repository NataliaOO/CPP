...
template <typename key_type, typename mapped_type>
const mapped_type *Map<key_type, mapped_type>::find(key_type const &key) const {
...
template <typename key_type, typename mapped_type>
size_t Map<key_type, mapped_type>::Size() {
  return size;
}
template <typename key_type, typename mapped_type>
inline typename Map<key_type, mapped_type>::const_iterator
...
template <typename key_type, typename mapped_type>
inline typename Map<key_type, mapped_type>::iterator
...
template <typename key_type, typename mapped_type>
inline void Map<key_type, mapped_type>::clear(Node<value_type> *node) {
  if (node) {
    clear(node->left);
    clear(node->right);
    delete node;
...
template <typename key_type, typename mapped_type>
inline void Map<key_type, mapped_type>::clear() {
  clear(root_);
  root_ = nullptr;
  size = 0;
}
...
template <typename key_type, typename mapped_type>
inline void Map<key_type, mapped_type>::insert(Node<value_type> *&node,
...
template <typename key_type, typename mapped_type>
typename std::pair<typename Map<key_type, mapped_type>::iterator, bool>
...
template <typename key_type, typename mapped_type>
typename std::pair<typename Map<key_type, mapped_type>::iterator, bool>
Map<key_type, mapped_type>::insert(key_type const &key,
                                   mapped_type const &obj) {
  Node<value_type> **cur = &root_;
  Node<value_type> *parent = nullptr;
  while (*cur) {
...
template <typename key_type, typename mapped_type>
typename std::pair<typename Map<key_type, mapped_type>::iterator, bool>
Map<key_type, mapped_type>::insert_or_assign(key_type const &key,
                                             mapped_type const &obj) {
  Node<value_type> **cur = &root_;
  Node<value_type> *parent = nullptr;
  while (*cur) {
...
typename Map<key_type,
             mapped_type>::template Node<std::pair<const key_type, mapped_type>>
    *Map<key_type, mapped_type>::find_node(Node<value_type> *node,
                                           const key_type &key) const {
  if (node == nullptr) {
    return nullptr;
...
template <typename key_type, typename mapped_type>
inline void Map<key_type, mapped_type>::swap(Map &other) {
...
template <typename key_type, typename mapped_type>
inline void Map<key_type, mapped_type>::merge(Map &other) {
...
template <typename key_type, typename mapped_type>
inline void Map<key_type, mapped_type>::erase(iterator pos) {
...
template <typename key_type, typename mapped_type>
inline void Map<key_type, mapped_type>::transplant(Node<value_type> *u,
                                                   Node<value_type> *v) {
  if (!u->parent) {
    root_ = v;
...
typename Map<key_type,
             mapped_type>::template Node<std::pair<const key_type, mapped_type>>
    *Map<key_type, mapped_type>::minimum(Node<value_type> *x) const {
  while (x->left) {
    x = x->left;
  }
  return x;
...
typename Map<key_type,
             mapped_type>::template Node<std::pair<const key_type, mapped_type>>
    *Map<key_type, mapped_type>::successor(Node<value_type> *x) const {
  if (x->right) {
